...
async def set_stage_aspect_ratio(
    ...
    """Persist the generation format before pricing.

    Aspect ratio belongs to the independently-priced Face/Fusion stage. The same
    durable stage metadata is read again during dispatch, preventing quote/render
    drift. Audio and Story Final stages intentionally cannot use this route.
    """
