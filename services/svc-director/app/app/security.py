...
async def get_director_auth(
    ...
    return DirectorAuthContext(user_id=user_id, account_id=account.account_id, claims=claims)


DirectorAuthDep = Depends(get_director_auth)
