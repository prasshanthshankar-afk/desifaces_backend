...
def _parse_first_image_url(d: Dict[str, Any]) -> str:
    ...
    for k in ("response", "output", "data"):
        ...
        if sub:
            return _parse_first_image_url(sub)
...
async def main_async(args) -> None:
    ...
    print("\n=== FAL RESULT ===")
    print("request_id:", dbg.get("request_id"))
...
def main() -> None:
    ...
    ap.add_argument("--lora-url", default="")
    ap.add_argument("--lora-scale", default="")
    ...
    ap.add_argument("--az-container", default="commerce-training")
    ap.add_argument("--proxy-prefix", default="training/tmp_proxy")
