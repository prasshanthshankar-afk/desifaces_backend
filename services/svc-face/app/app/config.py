...
class Settings(BaseSettings):
    ...
    # fal.ai
    FAL_API_KEY: str
    FAL_MODEL: str = "fal-ai/flux-pro/v1.1"             # text-to-image
    FAL_I2I_MODEL: str = "fal-ai/flux/dev/image-to-image"  # image-to-image (identity lock)
    FAL_I2I_DEFAULT_STRENGTH: float = 0.28
    ...
    FACE_OUTPUT_CONTAINER: str = "face-output"
    FACE_INPUT_CONTAINER: str = "face-input"
    FACE_INPUT_SAS_HOURS: int = 24         # for client preview links
    FACE_WORKER_SAS_MINUTES: int = 120     # fresh SAS for provider calls
