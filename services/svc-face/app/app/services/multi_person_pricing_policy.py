...
def install_multi_person_pricing_policy() -> None:
    """Install a narrow, idempotent Face Creator multi-person pricing selector."""
    ...
    def wrapped(self: CreatorOrchestrator, request_dict: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Face identity stages are priced per independently generated character.
        # Participant count chooses the premium SKU, but does not multiply this
        # character's natural variant workload again.
