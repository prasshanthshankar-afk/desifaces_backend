...
from .routes.canonical_face_assets import router as canonical_face_assets_router
...
def build_router() -> APIRouter:
    ...
    router.include_router(canonical_face_assets_router, prefix="/api/face", tags=["face"])
