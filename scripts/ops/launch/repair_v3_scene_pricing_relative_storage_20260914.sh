...
BACKUP="$HOME/df-v3-scene-pricing-before-relative-storage-${STAMP}.py"
TMP="$(mktemp -d)"
MUTATED=0
...
echo "============================================================"
echo " desifaces — V3 RELATIVE AUDIO STORAGE LINEAGE REPAIR"
...
timeout 90s docker exec -i "$EXT" python - <<PY
import asyncio
import asyncpg
import os
