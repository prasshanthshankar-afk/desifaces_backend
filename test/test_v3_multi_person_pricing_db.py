...
async def _run() -> None:
    ...
    try:
        ...
        # Face: each participant identity is already billed as an independent
        # premium Face job. The same per-character natural workload therefore
        # costs the same regardless of total cast size; multiplying again by
        # participant_count would double-charge Face.
